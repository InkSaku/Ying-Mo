...
CATEGORIES = {"skill_position", "turret_position", "grenade_throw", "detonator_throw", "hold_angle", "defense_position", "attack_route", "opening_tip", "energy_gain", "team_composition", "map_mechanic", "other"}
SIDES = {"attack", "defense", "both"}; DIFFICULTIES = {"beginner", "intermediate", "advanced"}; VALIDITIES = {"unverified", "valid", "possibly_invalid", "invalid"}
...
def validate_steps(user, steps, existing_steps=(), draft_media_ids=()):
    ...
    for item in steps:
        ...
        result.append((media, text(item.get("title"), 120, True), text(item.get("description"), 3000, True)))
    return result
