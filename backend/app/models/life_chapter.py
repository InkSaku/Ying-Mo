...
class LifeChapter(db.Model):
    ...
    parent = db.relationship("LifeChapter", remote_side=[id], backref=db.backref("children", lazy="select"))
    creator = db.relationship("User", backref=db.backref("life_chapters", lazy="dynamic"))
