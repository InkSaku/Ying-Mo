...
- 在游戏点位区，先选当前地图，再选英雄，快速查找可复现的实战点位；
...
地图优先检索守望先锋的英雄点位与实战经验。

- 以“游戏—地图—英雄—点位”组织知识
- 支持简单图文、分步说明、外部视频与版本信息
- 可按地图、英雄、区域、时机和点位类型快速查找
- 英雄与地图统一维护，减少重复内容
- 点位支持有效性反馈与后台状态治理
...
| 游戏点位 | 游戏目录、地图优先浏览、英雄点位、视频、版本与有效性反馈 |
| 内容互动 | 点赞、收藏、评论、回复、通知 |
