...
export async function getManagedLifeChapter(id) { const { data } = await apiClient.get(`/life/chapters/${id}/manage`); return data.data }
export async function updateLifeChapter(id, payload) { const { data } = await apiClient.patch(`/life/chapters/${id}`, payload); return data.data }
export async function getLifeChapterDeletionPreview(id) { const { data } = await apiClient.get(`/life/chapters/${id}/deletion-preview`); return data.data }
export async function deleteLifeChapter(id, payload) { const { data } = await apiClient.post(`/life/chapters/${id}/delete`, payload); return data.data }
